...
//-----------------------------------------------------------------------------
@interface ENGAVFoundationFlashButton(PrivateImplementation)
- (void) setText;
- (void) open;
- (void) close;
...
@implementation ENGAVFoundationFlashButton(PrivateImplementation)
...
- (void) setupInitialState{
    ...
    [offButton_ setTitle:NSLocalizedString(@"Flash_Off", nil) forState:UIControlStateNormal];
    ...
    [onButton_ setTitle:NSLocalizedString(@"Flash_On", nil) forState:UIControlStateNormal];
    ...
    [autoButton_ setTitle:NSLocalizedString(@"Flash_Auto", nil) forState:UIControlStateNormal];
...
-(void) setText{
    switch (flashMode_) {
        case AVCaptureFlashModeOn:
            label.text = NSLocalizedString(@"Flash_On", nil);
            break;
        case AVCaptureFlashModeOff:
            label.text = NSLocalizedString(@"Flash_Off", nil);
            break;
        case AVCaptureFlashModeAuto:
            label.text = NSLocalizedString(@"Flash_Auto", nil);
            break;            
        default:
            break;
    }
...
@implementation ENGAVFoundationFlashButton
